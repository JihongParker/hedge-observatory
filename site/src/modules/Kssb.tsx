      ...
      <div className="ks-cohorts">
        ...
        <table>
          ...
          <tbody>
            ...
            <tr><td className="mono">2030</td><td>외부 검증 의무화</td><td className="mono">해당 없음</td><td>어기면 책임을 지는 법정 공시가 됩니다</td></tr>
          </tbody>
        </table>
        <p className="ks-note">의무가 단계적으로 퍼지기 때문에, 행동 변화가 있다면 2030~31년에 몰려서 나타날 것으로 봅니다. 그 시점에 이 표를 열어 보는 것이 관측입니다.</p>
      </div>
    </section>
  )
}
